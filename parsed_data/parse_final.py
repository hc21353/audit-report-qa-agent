"""
audit_structure_table_parser_v5.py
...
9. [쉼표(,) 구분 오파싱 수정]
   - 주석 참조 "4, 6, 31" 같은 쉼표 구분 목록이 금액 파싱에서 "4631"로 합산되는 버그 수정
...
def parse_document_structure(htm_path: Path, output_dir: Path) -> Dict[str, Any]:
    ...
    # final_hierarchy.csv: 저장하지 않음 (불필요)
    # write_csv(output_dir / "final_hierarchy.csv", [asdict(x) for x in final_nodes])
...
if __name__ == "__main__":
    ...
    INPUT_DIR  = Path("삼성전자_감사보고서_2014_2024")
